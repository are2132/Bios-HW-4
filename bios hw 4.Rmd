...
$\hat{Y}$ = 5.499 + 0.211**X~i1~** + 2.18**X~i2~** - 0.1**X~i1~X~i2~**  
...
summary(mlr_big)
```
$\hat{Y}$ = 6.05 + 0.176**X~i1~** + 1.492**X~i2~** - 0.022**X~i3~** - 0.118**X~i4~** + 0.0055**X~i5~**  
...
$\hat{Y}$ = 4.76 + 0.171**X~i1~** + 1.529**X~i2~** + 0.005**X~i3~**  
  
We conclude then that an additional ER visit increases ln(total cost) by 0.171, having complications increases it by 1.53, and an additional day of stay increases it by 0.005.
